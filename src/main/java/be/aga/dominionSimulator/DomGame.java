...
public class DomGame extends Observable {
	...
	private void initialize() {
		...
		// adding the starting estates adds tokens to the trade route mat which we don't
		// want
	...
	private String getLandMarkText(DomPlayer thePlayer) {
		...
		if (getBoard().isLandmarkActive(DomCardName.Fountain)) {
			theBuilder.append("(").append(DomCardName.Fountain.toHTML()).append(":")
					.append(FountainCard.countVP(thePlayer)).append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Wolf_Den)) {
			theBuilder.append("(").append(DomCardName.Wolf_Den.toHTML()).append(":")
					.append(Wolf_DenCard.countVP(thePlayer)).append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Keep)) {
			theBuilder.append("(").append(DomCardName.Keep.toHTML()).append(":").append(KeepCard.countVP(thePlayer))
					.append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Museum)) {
			theBuilder.append("(").append(DomCardName.Museum.toHTML()).append(":").append(MuseumCard.countVP(thePlayer))
					.append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Obelisk)) {
			theBuilder.append("(").append(DomCardName.Obelisk.toHTML()).append(":")
					.append(ObeliskCard.countVP(thePlayer)).append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Orchard)) {
			theBuilder.append("(").append(DomCardName.Orchard.toHTML()).append(":")
					.append(OrchardCard.countVP(thePlayer)).append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Palace)) {
			theBuilder.append("(").append(DomCardName.Palace.toHTML()).append(":").append(PalaceCard.countVP(thePlayer))
					.append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Tower)) {
			theBuilder.append("(").append(DomCardName.Tower.toHTML()).append(":").append(TowerCard.countVP(thePlayer))
					.append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Triumphal_Arch)) {
			theBuilder.append("(").append(DomCardName.Triumphal_Arch.toHTML()).append(":")
					.append(Triumphal_ArchCard.countVP(thePlayer)).append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Wall)) {
			theBuilder.append("(").append(DomCardName.Wall.toHTML()).append(":").append(WallCard.countVP(thePlayer))
					.append("&#x25BC;) ");
		}
		if (getBoard().isLandmarkActive(DomCardName.Bandit_Fort)) {
			theBuilder.append("(").append(DomCardName.Bandit_Fort.toHTML()).append(":")
					.append(Bandit_FortCard.countVP(thePlayer)).append("&#x25BC;) ");
		}
	...
	public ArrayList<DomCard> getRogueableCardsInTrash() {
		...
		for (DomCard theCard : getTrashedCards()) {
			if (theCard.getCoinCost(this) >= 3 && theCard.getCoinCost(this) <= 6 && theCard.getPotionCost() == 0
					&& theCard.getCost(this).getDebt() == 0)
	...
	protected void initHumanOrPossessedPlayer() {
