...
public class DomCard implements Comparable<DomCard> {
	...
	public int getDiscardPriority(int aActionsLeft) {
		...
		// if (aActionsLeft>0 && getTrashPriority()<16 &&
		// owner.getCardsFromHand(DomCardType.Trasher).size()>0)
		// //added this to make sure player keeps Curse in hand when he also has a
		// Bishop for instance
