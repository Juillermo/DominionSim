...
public class DomGui extends JFrame implements ActionListener {
	...
	protected ArrayList<JButton> myBotSelectors = new ArrayList<JButton>();
	private DomBarChart myBarChart;
	private DomLineChart myVPLineChart;
	private DomLineChart myMoneyLineChart;
	protected HashMap<JButton, ButtonGroup> myStartStateButtonGroups = new HashMap<JButton, ButtonGroup>();
	...
	protected HashMap<DomPlayer, JButton> myPlayers = new HashMap<DomPlayer, JButton>();
	...
	protected DomPlayer getSelectedPlayer(JButton theSelector) {
