...
public class DomEngine {
	...
	protected DomGui myGui;
	private String myLastFile;
	private double myTotalTime;
	protected int emptyPilesEndingCount = 0;
	protected static DomGameFrame myGameFrame;
	protected DomGame currentGame;
	...
	private void printResults() {
		...
		if (NUMBER_OF_GAMES > 1) {
			for (DomPlayer thePlayer : players) {
				// myGui.showWinPercentage(thePlayer, thePlayer.getWins()*100/(theTotalWins
				// +theTotalTies/2));
				myGui.showWinPercentage(thePlayer, (int) (thePlayer.getWins() * 100 / NUMBER_OF_GAMES));
				// myGui.showTiePercentage(thePlayer.getTies()*100/(theTotalWins
				// +theTotalTies/2));
				...
				LOGGER.info(thePlayer + " has " + thePlayer.getWins() * 100 / NUMBER_OF_GAMES + "% wins ("
						+ thePlayer.getWins() + ")" + " and " + thePlayer.getTies() * 100 / NUMBER_OF_GAMES + "% ties ("
						+ thePlayer.getTies() + ")");
			}
	 ...
	 * 
	 * @param aString
	 *            String identifying the bot or player
